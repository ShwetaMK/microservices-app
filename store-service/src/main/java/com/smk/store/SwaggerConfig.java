...
public class SwaggerConfig {
	@Bean
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("book-store").select()
				.apis(RequestHandlerSelectors.basePackage("com.smk.store.controller")).paths(PathSelectors.any())
//				.apiInfo(apiInfo())
//				.paths(postPaths())
				.build();
